  ...
  const mockCategories = [
    {
      id: '1',
      name: 'Tops',
      subcategories: ['T-Shirts', 'Shirts', 'Blouses', 'Sweaters', 'Tank Tops'],
    },
    {
      id: '2',
      name: 'Bottoms',
    ...
    },
    {
      id: '3',
      name: 'Outerwear',
      subcategories: ['Jackets', 'Coats', 'Hoodies', 'Blazers', 'Vests'],
    },
    {
      id: '4',
      name: 'Dresses & Jumpsuits',
      subcategories: ['Casual Dress', 'Formal Dress', 'Jumpsuit', 'Romper'],
    },
    {
      id: '5',
      name: 'Footwear',
    ...
    },
    {
      id: '6',
      name: 'Accessories',
      subcategories: ['Hats', 'Bags', 'Belts', 'Scarves', 'Jewelry'],
    },
  ]
    ...
    <div className="min-h-screen p-2 sm:p-4 lg:p-6 pb-24">
      <div className="max-w-2xl mx-auto backdrop-blur-xl bg-white/70 dark:bg-gray-900/70 p-4 sm:p-8 rounded-2xl shadow-2xl border border-white/20 dark:border-gray-800">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-8">
          Add the essential details for your new wardrobe piece below.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {imagePreview ? (
                <div className="relative group transition-all duration-300 ease-in-out motion-safe:animate-fadeIn">
                  ...
                  <button
                    type="button"
                    onClick={removeImage}
                    className="absolute top-3 right-3 p-1.5 bg-black/60 text-white rounded-full opacity-0 group-hover:opacity-100 transition-opacity hover:bg-red-500"
                  >
                    <X size={18} />
                  </button>
                </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {predefinedColors.map((color) => (
                      <button
                        ...
                        className={`w-9 h-9 rounded-full border-2 transition-transform transform hover:scale-110 focus:outline-none ${
                    ...
                    <button
                      ...
                      className={`w-9 h-9 flex items-center justify-center rounded-full border-2 transition-transform transform hover:scale-110 focus:outline-none ${
                        showCustomColor
                          ? 'border-blue-500 ring-2 ring-blue-500 ring-offset-2 ring-offset-white dark:ring-offset-gray-900'
                          : 'border-gray-300 dark:border-gray-700'
                      }`}
          ...
          <div className="pt-4 flex justify-end">
            ...
            >
              {isLoading ? (
                <>
                  <Loader2 size={20} className="animate-spin" /> Adding Item...
                </>
              ) : (
