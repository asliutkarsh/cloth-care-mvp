...
export default function BulkActionBar({ count, onDelete, onAddToLaundry, onCreateOutfit, onCancel, className = '' }) {
  if (count === 0) return null
  return (
    <div className={`fixed z-40 ${className}`}>
      <div className="w-full flex flex-wrap items-center justify-center gap-2 rounded-xl px-3 py-2 backdrop-blur bg-white/95 dark:bg-gray-900/95 border border-gray-200 dark:border-gray-700 shadow-lg">
